...
static const devmgr_pci_vendor_t g_devmgr_pci_vendors[] = {
    ...
    {0x1008, "Epson"},
    {0x100A, "├éas Ltd. de Phoenix del ┬â de Tecnolog├â"},
    ...
    {0x13B5, "ARM"},
    {0x13B6, "DLoG Gesellschaft f³r elektronische Datentechnik mbH"},
    ...
    {0x15CE, "Genrad Inc"},
    {0x15CF, "Hilscher Gesellschaft f├╝r Systemautomation mbH"},
    ...
    {0x1E7E, "9034 Pliops-Data Processor [XDP1.0]"},
