...
typedef gui_image_t bk_gui_image_t;
typedef net_info_t bk_net_info_t;
typedef perfmon_snapshot_t bk_perf_snapshot_t;
typedef perfmon_benchmark_result_t bk_perf_benchmark_t;
...
/* DTO seguros para aplicaciones Ring 3. No exponen las tablas internas de
 * dispositivos que ahora viven en paginas supervisor. Mantenerlos sincronizados
 * con sdk/include/bleskernos_api.h. */
typedef enum {
    BK_BLOCK_NONE = 0,
    BK_BLOCK_ATA,
    BK_BLOCK_FLOPPY,
...
/* Transporte de impresion. El lenguaje/rasterizado permanece en Ring 3. */
...
/* Idioma global y catalogos de /SYSTEM/LENG. */
...
/* Presentacion sincrona para tareas Ring 3 que realizan una operacion
 * bloqueante dentro de un callback. La aplicacion dibuja en la superficie
 * devuelta y finaliza con bk_gui_window_end_immediate_paint(). */
...
/* Consultas de hardware por copia. Las variantes *_at heredadas devuelven
 * punteros internos y no deben usarse desde aplicaciones Ring 3. */
