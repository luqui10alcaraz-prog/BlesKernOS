...
.new_attrib:
	...
	.color_msg	db 'Primero selecciona un color de primer plano', 0
	.color2_msg	db 'y luego un color de fondo.', 0
...
.help:
	...
	.help_list		db '[F1] - archivo,[F2] - Selector de color,[F3] - Rellenar pantalla con color,[F4] - Selector de caracteres,[F5] - Usar el carácter elegido,[F6] - Rellenar pantalla con el carácter elegido', 0
	.help_msg		db 'ayuda :', 0
	.help_msg2		db 0
...
.save_as:
	...
	.file_list			db 'Nuevo,abrir...,Salvar,Salvar y...,salir', 0
	.save_error_msg		db 'Error al guardar el archivo!', 0
	.save_msg			db 'Introduce un nombre de archivo (PICTURE.ASC):', 0
	.load_file			db 'Unnamed picture', 0
	.save_flag			db 0
	.extension_number	db 1
	.asc_extension		db 'ASC', 0
	.err_string			db 'archivo invalido!', 0
	.err_string2		db '80x25 ASC solo!', 0
	.save_ok_msg		db 'Archivo guardado.', 0
...
draw_background:
	...
	.title_msg			db 'BlesKernOS ASCII Artist - ', 0
	.footer_msg			db '[F1] - archivo, [F2] - elegir color, [F3] - llenar con color, [F12] - mas ayuda', 0
