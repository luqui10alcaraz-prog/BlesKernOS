...
#define BK_SYSCALL_ABI_VERSION 5U
#define BK_SOCKET_TCP 1U
...
/* Raw Phase-3 thread syscalls. Applications should normally use the higher
 * level API from bleskernos_thread.h. */
...
void bk_thread_sys_exit(bk_i32 result) __attribute__((noreturn));
